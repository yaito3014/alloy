...
#define YK_ALLOY_TUPLE_DETAIL_FORWARDING_CONSTRUCTOR_PARAMS(z, i, name_tuple) \
  BOOST_PP_COMMA_IF(i) BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(1, name_tuple), i) && BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(4, name_tuple), i)

#define YK_ALLOY_TUPLE_DETAIL_FORWARDING_INITIALIZE_MEMBERS(z, i, name_tuple) \
  BOOST_PP_COMMA_IF(i)                                                        \
  BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, name_tuple), i)(static_cast<BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(1, name_tuple), i) &&>(BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(4, name_tuple), i)))
...
#define YK_ALLOY_TUPLE_DETAIL_DECLARE_MEMBER(z, i, name_tuple) \
  YK_ALLOY_DETAIL_NO_UNIQUE_ADDRESS BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(0, name_tuple), i) BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, name_tuple), i);
...
#define YK_ALLOY_TUPLE_DETAIL_DEFINE_TUPLE_IMPL(z, n, name_tuple)                                                                                                 \
  template<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_TEMPLATE_PARAMS, BOOST_PP_TUPLE_ELEM(0, name_tuple))>                                                         \
  class tuple_impl<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_ARGS, BOOST_PP_TUPLE_ELEM(0, name_tuple))> {                                                          \
  public:                                                                                                                                                         \
    BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_DECLARE_MEMBER, name_tuple)                                                                                          \
    constexpr explicit tuple_impl() = default;                                                                                                                    \
    constexpr explicit tuple_impl(value_initialize_t) : BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_VALUE_INITIALIZE_MEMBERS, BOOST_PP_TUPLE_ELEM(2, name_tuple)) {} \
    template<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_TEMPLATE_PARAMS, BOOST_PP_TUPLE_ELEM(1, name_tuple))>                                                       \
    ...
    template<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_TEMPLATE_PARAMS, BOOST_PP_TUPLE_ELEM(1, name_tuple))>                                                       \
    constexpr explicit tuple_impl(tuple_impl<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_ARGS, BOOST_PP_TUPLE_ELEM(1, name_tuple))>& another)                        \
        : BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_ANOTHER_INITIALIZE_MEMBERS_LVALUE_REFERENCE, BOOST_PP_TUPLE_ELEM(2, name_tuple))                               \
    {                                                                                                                                                             \
    }                                                                                                                                                             \
    template<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_TEMPLATE_PARAMS, BOOST_PP_TUPLE_ELEM(1, name_tuple))>                                                       \
    constexpr explicit tuple_impl(tuple_impl<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_ARGS, BOOST_PP_TUPLE_ELEM(1, name_tuple))> const& another)                  \
        : BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_ANOTHER_INITIALIZE_MEMBERS_LVALUE_REFERENCE, BOOST_PP_TUPLE_ELEM(2, name_tuple))                               \
    {                                                                                                                                                             \
    }                                                                                                                                                             \
    template<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_TEMPLATE_PARAMS, BOOST_PP_TUPLE_ELEM(1, name_tuple))>                                                       \
    constexpr explicit tuple_impl(tuple_impl<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_ARGS, BOOST_PP_TUPLE_ELEM(1, name_tuple))>&& another)                       \
        : BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_ANOTHER_INITIALIZE_MEMBERS_RVALUE_REFERENCE, BOOST_PP_TUPLE_ELEM(2, name_tuple))                               \
    {                                                                                                                                                             \
    }                                                                                                                                                             \
    template<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_TEMPLATE_PARAMS, BOOST_PP_TUPLE_ELEM(1, name_tuple))>                                                       \
    constexpr explicit tuple_impl(tuple_impl<BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_ARGS, BOOST_PP_TUPLE_ELEM(1, name_tuple))> const&& another)                 \
    ...
    {                                                                                                                                                             \
      BOOST_PP_REPEAT(n, YK_ALLOY_TUPLE_DETAIL_GET, BOOST_PP_TUPLE_ELEM(2, name_tuple))                                                                           \
    }                                                                                                                                                             \
  };

BOOST_PP_REPEAT_FROM_TO(1, YK_ALLOY_TUPLE_LIMIT, YK_ALLOY_TUPLE_DETAIL_DEFINE_TUPLE_IMPL, (T, U, _, x, y))

template<BOOST_PP_REPEAT(YK_ALLOY_TUPLE_LIMIT, YK_ALLOY_TUPLE_DETAIL_TEMPLATE_PARAMS, T), class... Ts>
class tuple_impl<BOOST_PP_REPEAT(YK_ALLOY_TUPLE_LIMIT, YK_ALLOY_TUPLE_DETAIL_ARGS, T), Ts...> {};
